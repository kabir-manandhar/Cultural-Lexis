...
pretrain_model_dir=/data/projects/punim0478/sukaih/Sukai_Project/huahua/data/07_model_output/llama3/swow_zh
output_tag=ftd_n_ppo
pretrain_model=/data/projects/punim0478/sukaih/Sukai_Project/huahua/data/07_model_output/llama3/swow_zh/lora_combined
data_info=/data/03_primary/openrlhf_dataset/swow_zh
...
ray job submit --address="http://127.0.0.1:8265" \
   --runtime-env-json='{"working_dir": "/data/gpfs/projects/punim2219/LM_with_SWOW/sukaih/cultural-lexis-finetune-llms", "env_vars": {"DATA_NAME": "swow_zh"}}' \
   -- python3 -m openrlhf.cli.train_ppo_ray \
   ${PPO_FLAGS} \
   --use_wandb e306c9c2aee5b8224dcfeaab47393338739db3fe \
   --wandb_project llamafactory \
   --wandb_run_name ${output_tag}${pretrain_model}_swow_zh