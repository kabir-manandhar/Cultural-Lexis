...
# cultural_lexis_finetune_llms documentation build
...
from cultural_lexis_finetune_llms import __version__ as release

# -- Project information -----------------------------------------------------

project = "cultural_lexis_finetune_llms"
author = "Kedro"
...
htmlhelp_basename = "cultural_lexis_finetune_llmsdoc"
...
latex_documents = [
    (
        master_doc,
        "cultural_lexis_finetune_llms.tex",
        "cultural_lexis_finetune_llms Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cultural_lexis_finetune_llms",
        "Project cultural_lexis_finetune_llms codebase.",
        "Data-Science",
    )
]
